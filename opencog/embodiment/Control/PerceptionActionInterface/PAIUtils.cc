...
std::string PAIUtils::getSerializedXMLString(XERCES_CPP_NAMESPACE::DOMDocument * doc) throw (opencog::RuntimeException, std::bad_exception)
{
    ...
    try {
        ...
        XERCES_CPP_NAMESPACE::DOMLSOutput *output = ((XERCES_CPP_NAMESPACE::DOMImplementationLS*)pImplement)->createLSOutput();
//        dc->setParameter(XERCES_CPP_NAMESPACE::XMLUni::fgDOMErrorHandler,errorHandler);
